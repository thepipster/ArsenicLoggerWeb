...
Account = {
    ...
    init : function(){
        ...
        this.Model = Settings.mongoConn.model('Accounts', this.AccountSchema);
    },
    ...
    loadFromCompany : function(company, callback){ this.Model.findOne({'company': company}, callback);},

    loadFromSecretKey : function(key, callback){ this.Model.findOne({'apiKey': key}, callback);},

    getAccountIdFromSecretKey : function(key, callback){ this.getVar({'apiKey': key}, '_id', callback);},
    ...
    create : function(companyName, callback) {
        ...
        function generateSecretKey(callback){
            ...
            Account.loadFromSecretKey(token, function(err, app){
